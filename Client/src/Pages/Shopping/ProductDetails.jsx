    ...
    <div>
      <div className='flex flex-wrap lg:p-8 md:p-5 sm:p-2 pb-0 bg-white'>
        <div className='flex flex-col p-2 w-full md:w-3/7 min-w-[100px] gap-3'>
          <ScrollArea className="md:h-[1020px] px-4 py-2">
            <div className='flex w-full'>
              <div className='flex flex-col items-center justify-center w-full gap-10 bg-gray-100 rounded-md p-7 border'>
                <img src={productData?.avatar} className='aspect-square w-full object-contain drop-shadow-2xl' />
              </div>
              <div className='grow p-2 flex flex-col justify-between items-center'>
                <div className='flex flex-col gap-5 items-center'>
                  <button className='p-2 bg-blue-100 text-blue-700 cursor-pointer rounded-md'><Share size={20} /></button>
                  <button className='p-2 bg-blue-100 text-blue-700 cursor-pointer rounded-md'><Heart size={20} /></button>
                </div>
                <div className='flex flex-col gap-5 items-center'>
                  <button className='p-2 bg-blue-100 text-blue-700 cursor-pointer rounded-md'><ArrowLeft size={20} /></button>
                  <button className='p-2 bg-blue-100 text-blue-700 cursor-pointer rounded-md'><ArrowRight size={20} /></button>
                </div>
              </div>
            </div>
            <div className='flex gap-1 sm:gap-2 md:gap-3 lg:gap-4 py-2 w-full'>
              {productData?.otherImages?.map((_, index) =>
                <div key={index} className='p-2 h-28 w-28 bg-gray-100 flex items-center justify-center rounded-md'>
                  <img src={photo} alt="" className='p-1 drop-shadow-lg' />
                </div>
              )}
            </div>
            ...
            <div onClick={() => setIconRotate(!iconRotate)} className='select-none cursor-pointer flex gap-1 text-sm text-gray-500 font-semibold justify-center'>View {iconRotate ? "Less" : "More"} Detsils
