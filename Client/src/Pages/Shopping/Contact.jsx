        ...
        <div className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-start">
          <div className="space-y-6">
            ...
            <p className="text-gray-600 text-base">
              Whether it's a delivery delay, refund issue, or product feedback —
              our support team is here for you. We respond quickly to ensure a
            ...
            <div className="mt-6 space-y-4 text-gray-700 text-sm">
              <div className="flex items-start gap-3">
                ...
                <p>
                  <strong>Store Location:</strong> 123 Main Street, Kolkata, WB
                </p>
              </div>
              <div className="flex items-start gap-3">
                <Phone className="text-green-600 w-5 h-5 mt-1" />
                <p>
                  <strong>Quick Support:</strong> +91 1234567890
                </p>
              </div>
              <div className="flex items-start gap-3">
                <Mail className="text-green-600 w-5 h-5 mt-1" />
                <p>
                  <strong>Email:</strong> help@greenbusket.com
                </p>
              </div>
              <div className="flex items-start gap-3">
                <Clock className="text-green-600 w-5 h-5 mt-1" />
                <p>
                  <strong>Support Hours:</strong> 7:00 AM – 11:00 PM, All Days
                </p>
              </div>
            </div>
